SELECT cws.ContactKey,
    ...
    WHERE
    (cws1.SubscriptionProduct LIKE '%Reading%' OR cws1.SubscriptionProduct LIKE '%Writing%') AND
    cws1.ActiveFullSubscriptions NOT LIKE '%Mathletics%' AND
    cws1.ActiveFullSubscriptions NOT LIKE '%Mathseeds%' AND
