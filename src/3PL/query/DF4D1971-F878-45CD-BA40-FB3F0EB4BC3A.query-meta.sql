...
WHERE
    cws.SubscriptionProduct    LIKE '%Reading%'  AND
    ...
    rel.Product_Influencer__c  LIKE '%Reading%' AND
    ...
    AND NOT EXISTS
      (SELECT ContactKey
       FROM MX_APAC_LOST_CUSTOMERS_OLDER_THAN_3M_GT_3Y mx WHERE mx.ContactKey = cws.ContactKey )
