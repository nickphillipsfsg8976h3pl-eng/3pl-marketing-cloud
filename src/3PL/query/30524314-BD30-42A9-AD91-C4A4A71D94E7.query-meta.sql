SELECT
    ...
    cws.Status__c as SubscriptionStatus,
    cws.Student_Cap__c,
    cws.Registered_Students__c,
    cws.Subscriptions_Remaining__c,
...
WHERE
    ...
    cws.Start_Date__c < DATEADD(day, 0, GETDATE()) AND
    cws.End_Date__c > DATEADD(day, 0, GETDATE()) AND
    cws.Subscriptions_Remaining__c < 0 AND
    ...
    (a.Name NOT LIKE '%Test%' AND a.Name NOT LIKE '%fake%' AND a.Name NOT LIKE '%inactive%' AND a.Name NOT LIKE '%duplicate%')
GROUP BY
    c.Email,
    c.Id,
    cws.ProdName__c,
