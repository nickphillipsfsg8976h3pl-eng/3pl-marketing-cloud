...
WHERE 
    cws.CampaignId IN (
        '701Mp00000WYgGvIAL','701Mp00000VD5CyIAL','701Mp00000Wpw7mIAB'
    )
    AND cws.Email is Not null
    AND cws.[Email] NOT IN (
        SELECT ex.[CampaignMember:Email]
 
        FROM [AMER_3P0061_Literacy_Fluency_Nurture - 2025-02-24T102450886] ex where ex.[CampaignMember:Email] is Not null 
    )
