...
where 
(chargebeeapps__Subscription_status__c  = 'IN_TRIAL') 
AND 
chargebeeapps__Trail_End__c < GETDATE() 
and 
chargebeeapps__Trial_Start__c > DATEADD(MONTH, -48, GETDATE())
and c.Name != 'wmd-mathletics-trial'