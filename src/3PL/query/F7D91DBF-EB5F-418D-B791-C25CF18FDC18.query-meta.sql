SELECT cws.ContactKey,
    ...
    WHERE
    (cws1.SubscriptionProduct LIKE '%Mathletics%' OR cws1.SubscriptionProduct LIKE '%Mathseeds%') AND
    cws1.ActiveFullSubscriptions NOT LIKE '%Reading%' AND
    cws1.ActiveFullSubscriptions NOT LIKE '%Writing%' AND
