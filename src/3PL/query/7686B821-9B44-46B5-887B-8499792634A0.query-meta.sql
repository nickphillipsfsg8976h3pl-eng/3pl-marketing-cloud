...
WHERE
    ...
    cws.SubscriptionEndDate    >  DATEADD(month, -36, GETDATE()) AND
    ...
    a.Territory__c             = 'Africa' AND
    cws.AccountBillingCountry  ='South Africa' AND
    ...
    AND NOT EXISTS
      (SELECT ContactKey
       FROM MX_APAC_ZA_LOST_RENEWALS_OLDER_THAN_3M_ES mx WHERE mx.ContactKey = cws.ContactKey )