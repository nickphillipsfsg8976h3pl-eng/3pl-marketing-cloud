...
WHERE
    ...
    ((cws.ContactJobFunction NOT LIKE '%IT%' AND cws.ContactJobFunction NOT LIKE '%Accounts%') OR cws.ContactJobFunction IS NULL ) AND
    ...
    (cws.AccountBillingCountry = 'Australia' or cws.AccountBillingCountry ='New Zealand') AND
