...
WHERE
    ...
    AND o.Type = 'Renewal'
    AND (
    o.Productlist__c LIKE '%Maths Package%'
    OR o.Productlist__c LIKE '%Literacy Package%'
    OR o.Productlist__c LIKE '%Better Ways To Learn Package%'
    OR o.Productlist__c LIKE '%Mathletics%'
    OR o.Productlist__c LIKE '%Mathseeds%'
    OR o.Productlist__c LIKE '%Reading Eggs%'
    OR o.Productlist__c LIKE '%Writing Legends%'
    OR o.Productlist__c LIKE '%Reading Eggs, Mathseeds, Mathletics, Maths Package%'
    )  
    AND o.Productlist__c NOT LIKE '%3 Essentials Package%'
