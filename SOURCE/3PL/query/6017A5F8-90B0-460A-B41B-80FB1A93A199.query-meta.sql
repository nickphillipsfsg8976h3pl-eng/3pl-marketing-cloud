...
WHERE
    (((cws.ActiveFullSubscriptions LIKE '%Mathseeds%' AND cws.ActiveFullSubscriptions NOT LIKE '%Reading%') AND
    ...
    c.Students_in_WL_Class__c > 0 AND
    c.first_wl_class_added_date__c >'2023-01-01') OR
    ...
    c.Is_Active__c = 'true' AND
    c.Students_in_WL_Class__c > 0 AND
    c.first_wl_class_added_date__c >'2023-01-01')) AND
