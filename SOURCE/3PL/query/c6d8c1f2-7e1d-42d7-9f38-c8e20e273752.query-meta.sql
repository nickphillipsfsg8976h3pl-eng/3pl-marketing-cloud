...
where 
(chargebeeapps__Subscription_status__c ='ACTIVE' Or chargebeeapps__Subscription_status__c  = 'NON_RENEWING' OR chargebeeapps__Subscription_status__c  = 'CANCELLED') 
AND 
chargebeeapps__Current_Term_End__c < GETDATE()
AND 
chargebeeapps__Current_Term_Start__c > DATEADD(MONTH, -48, GETDATE())