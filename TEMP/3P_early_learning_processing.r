...
%%[
        ...
        *****************/
        ...
        if @_re_interest == 'quote_mr' or @_re_interest == 'demo_mr'  then
          set @_Product_Interest = "Mathseeds;ReadingEggs"
        elseif @_re_interest == 'quote_m' or @_re_interest == 'demo_m' then
          set @_Product_Interest = "Mathseeds"
        elseif @_re_interest == 'quote_r' or @_re_interest == 'demo_r' then
          set @_Product_Interest = "ReadingEggs"
        endif
        ...
        if not empty(@_Campaign_Name) then
          if @_Campaign_Name == '701Mp00000F4QRVIA3' then
            set @_Campaign_Code ='AMER_RE0041_DistrictProspecting_CAN'
            if @_re_interest == 'quote' then
               set @Description = "This prospect has requested a quote from the Canadian Reading Eggs District Landing Page."
            elseif @_re_interest == 'demo' then
               set @Description = "This prospect has requests a product consultation from the Canadian Reading Eggs District Landing Page."
            endif
          endif
          if @_Campaign_Name == '701Mp00000OlY22IAF' then
            set @_Campaign_Code ='AMER_RE0106_FY25CrossSell_CAN'
            if @_re_interest == 'quote' then
               set @Description = "This prospect has requested a quote from the Canadian Reading Eggs District Cross Selling Landing Page."
            elseif @_re_interest == 'demo' then
               set @Description = "This prospect has requests a product consultation from the Canadian Reading Eggs District Cross Selling Landing Page."
            endif
          endif
          if @_Campaign_Name == '701Mp00000RSp6WIAT' then
            set @_Campaign_Code ='AMER_3P0040_US_Early Learning_MS_RE'
            if indexOf(@_re_interest,'quote')>0 then
               set @Description = "This prospect has requested a quote from the AMER Early Learning_MS_RE Landing Page."
            elseif indexOf(@_re_interest,'demo')>0 then
               set @Description = "This prospect has requests a product consultation from the AMER Early Learning_MS_RE Landing Page."
            endif
          endif
  ...
  set @LEAD__New_Id = CreateSalesforceObject("Lead", 30,
              ...
              'MSCLKID__c', IIF(Not Empty(@msclkid), @msclkid, 'Unknown'),
              'FBCLID__c', IIF(Not Empty(@fbclid), @fbclid, 'Unknown'),
