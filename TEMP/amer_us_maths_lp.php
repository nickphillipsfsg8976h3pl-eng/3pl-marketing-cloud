...
<head>
    ...
    <!-- Title & Favicons -->
    <title> 3PLearning | Early Learning form </title>
 ...
 ******************/
        :root {
            ...
            --submit_button__rest--backgroundColor: #02A1DF;
            --submit_button__rest--color: whitesmoke;
            --submit_button__hover--backgroundColor: #0268AD;
...
<body>
    ...
    <form id="re-mr-re-can-form"
        action="https://web.my.3plearning.com/3P_amer_maths_processing"
        method="POST"
        target="_parent"
                        ...
                        <div class="col">
                            <div class="form-group" style="margin-bottom: 30px;">
                                ...
                                <select class="form-control"
                                    ...
                                    <option value="quote_msmx">Request a quote for Mathseeds and Mathletics</option>
                                    <option value="demo_msmx">Request a demo for Mathseeds and Mathletics</option>
                                    <option value="quote_ms">Request a quote for Mathseeds</option>
                                    <option value="demo_ms">Request a demo for Mathseeds</option>
                                    <option value="quote_mx">Request a quote for Mathletics</option>
                                    <option value="demo_mx">Request a demo for Mathletics</option>
