...
set @campaignNameLookup = @_Campaign_Name
...
set @_Product_Interest = "Mathseeds"
...
set @enquiry = 'Quote'
elseif indexOf(@_re_interest,'demo')>0 then
set @enquiry = 'Demo'
else
set @enquiry = ''
endif

if @_re_interest == 'quote_msmx' or @_re_interest == 'demo_msmx' then
set @_Product_Interest = "Mathseeds;Mathletics"
elseif @_re_interest == 'quote_ms' or @_re_interest == 'demo_ms' then
set @_Product_Interest = "Mathseeds"
elseif @_re_interest == 'quote_mx' or @_re_interest == 'demo_mx' then
set @_Product_Interest = "Mathletics"
endif

set @_Campaign_Code =''

if not empty(@_Campaign_Name) then
if @_Campaign_Name == '701Mp00000W13BEIAZ' then
set @_Campaign_Code ='AMER_3P0067_Maths_Landing_Page'
if indexOf(@_re_interest,'quote')>0 then
set @Description = "This prospect has requested a quote from the AMER US Maths Landing Page."
elseif indexOf(@_re_interest,'demo')>0 then
set @Description = "This prospect has requests a product consultation from the AMER US Maths Landing Page."
endif
endif
...
if @debug == true then
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Campaign_Name: ', @_Campaign_Name, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Campaign_Code: ', @_Campaign_Code, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@campaignNameLookup: ', @campaignNameLookup, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_re_interest: ', @_re_interest, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Product_Interest: ', @_Product_Interest, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Product_Interest_c: ', @_Product_Interest_c, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_First_Name: ', @_First_Name, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Last_Name: ', @_Last_Name, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Email_Address: ', @_Email_Address, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Phone_Number: ', @_Phone_Number, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Country_Name : ', @_Country_Name , '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_State_Name: ', @_State_Name, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Other_Job_Title: ', @_Other_Job_Title, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_School_Name: ', @_School_Name, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Enquiry_Type : ', @_Enquiry_Type , '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@enquiry : ', @enquiry , '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Terms_And_Conditions: ', @_Terms_And_Conditions, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Subscriber_Opt_In : ', @_Subscriber_Opt_In, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@LeadStatus: ', @LeadStatus, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@LeadSource: ', @LeadSource, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@_Job_Title: ', @_Job_Title, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@LeadStage: ', @LeadStage, '</code></pre>'))
OutputLine(Concat('
<pre style="background-color:#ccc;"><code>@Description: ', @Description, '</code></pre>'))
else]%%
...
"Country", IIF(Not Empty(@_Country_Name), @_Country_Name, "Canada"),
...
*/
set @RedirectURL= "https://www.3plearning.com/quote/thank-you/"
